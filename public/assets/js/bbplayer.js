...
(function () {
  ...
  BBPlayer.prototype.initVolumeSlider = function () {
    var self = this;
    var audioElem = self.bbaudio;
    var slider = self.bbplayer.getElementsByClassName('bb-volume-slider')[0];
  
    slider.setAttribute("min", "0");
    slider.setAttribute("max", "1");
    audioElem.volume = slider.value;
    slider.addEventListener('input', function () {
      audioElem.volume = slider.value;
        self.log('event: change .bb-volume-slider');
    });
    ...
    slider.addEventListener('input', function () {
      ...
      self.log('event: change .bb-volume-int');
    });
  };
